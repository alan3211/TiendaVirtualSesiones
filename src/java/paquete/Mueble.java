...
public class Mueble extends HttpServlet {   
    ...
    throws ServletException, IOException { 
        ...
        out.println("<!DOCTYPE html>\n"
                ...
                + "                     <p>$8,000</p>\n");
                                    if(atributos[8] == null)  out.println( "                     Agregar: &nbsp;&nbsp;<input type=\"checkbox\" name=\"pr8\" >");
                ...
                + "                     <p>$2,800</p>\n");
                                    if(atributos[9] == null)  out.println( "                     Agregar: &nbsp;&nbsp;<input type=\"checkbox\" name=\"pr9\" >");
                ...
                + "                     <p>$7,000</p>\n");
                  if(atributos[10] == null)  out.println( "                     Agregar: &nbsp;&nbsp;<input type=\"checkbox\" name=\"pr10\" >");
               ...
               out.println( "             </div>           \n"
                ...
                + "                     <p>$10,000</p>\n");
                  if(atributos[11]== null)  out.println( "                     Agregar: &nbsp;&nbsp;<input type=\"checkbox\" name=\"pr11\" >");
